...
# replace all ="src/ with ="https://alexeyhimself.github.io/dtu_gw/src/
sed -i '' 's/href="src/href="https:\/\/alexeyhimself.github.io\/dtu_gw\/src\/dtu_app\/src/g' $NEW_REMOTE_FILE_NAME
sed -i '' 's/src="src/src="https:\/\/alexeyhimself.github.io\/dtu_gw\/src\/dtu_app\/src/g' $NEW_REMOTE_FILE_NAME
